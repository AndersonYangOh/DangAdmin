		...
		$.ajax({
			...
			success: function (result) {
				...
				for (var i in list){
					...
					html += '<td>'+
								'<c:if test="${sessionScope.funOperate[\'RUDANG_PROCESS_MANAGE_CHECK\'] }">'+
								'<a class="btn btn-op" data-toggle="modal" href="Process/toRudangProcess.do?operId='+list[i].operId+'" title="查看"><i class="fa fa-search"></i></a>'+
								'</c:if>'+ 
								'</td>';
					html += "</tr>";
				}
				...
				<div class="search-form  ">
					<form id="searchForm">
						<div class="row cl">
							...
							<div class="col-sm-3 text-r">
								<a  class="btn btn-primary " href="operOrgan/exportExcel.do">导出</a> 
