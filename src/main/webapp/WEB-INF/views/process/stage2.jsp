...
function left(){
	var loca = "Process/toRudangProcess.do?materialId=1&operId="+operId;
	window.location.href=loca;
}
                ...
                if(msg.flag){
                    ...
                    if(process.length>0){
                        ...
                        if(process[0].status==1){
                        	document.getElementById('31').innerHTML = "<input type='button' value='通过' onclick='updateRudangProcess31()'>正在进行";
                        ...
                        if(process[1].status==1){
                        	document.getElementById('32').innerHTML = "<input type='button' value='通过' onclick='updateRudangProcess32()'>正在进行";
                        ...
                        if(process[2].status==1){
                        	document.getElementById('33').innerHTML = "<input type='button' value='通过' onclick='updateRudangProcess33()'>正在进行";
                        ...
                        if(process[3].status==1){
                        	document.getElementById('34').innerHTML = "<input type='button' value='通过' onclick='updateRudangProcess34()'>正在进行";
                      ...
                      //Stage35完成情况
                        ...
                        if(process[4].status==1){
                        	document.getElementById('35').innerHTML = "<input type='button' value='通过' onclick='updateRudangProcess35()'>正在进行";
                      ...
                      //Stage41完成情况
                    	...
                    	$("#uncompletionDescriptionStage41").val(process[5].uncompletionDescription);
                   
                        if(process[5].status==1){
                        	document.getElementById('41').innerHTML = "<input type='button' value='通过' onclick='updateRudangProcess41()'>正在进行";
                      ...
                      //Stage42完成情况
                        ...
                        if(process[6].status==1){
                        	document.getElementById('42').innerHTML = "<input type='button' value='通过' onclick='updateRudangProcess42()'>正在进行";
                      ...
                      //Stage5完成情况  
                        ...
                        document.getElementById('5').innerHTML = "<input type='button' value='通过' onclick='updateRudangProcess5()'>";
                      ...
                      //Stage61完成情况
                        ...
                        */
                        ...
                        document.getElementById('61').innerHTML = "<input type='button' value='通过' onclick='updateRudangProcess61()'>";
                        ...
                        document.getElementById('62').innerHTML = "<input type='button' value='通过' onclick='updateRudangProcess62()'>";
                      ...
                      //Stage63完成情况
                        ...
                        document.getElementById('63').innerHTML = "<input type='button' value='通过' onclick='updateRudangProcess63()'>";
                      ...
                      //Stage64完成情况
                        ...
                        if(process[11].status==1){
                        	document.getElementById('64').innerHTML = "<input type='button' value='通过' onclick='updateRudangProcess64()'>正在进行";
                      ...
                      //StageB2完成情况
                        ...
                        if(process[13].status==1){
                        	document.getElementById('Blank2').innerHTML = "<input type='button' value='通过' onclick='updateRudangProcessBlank2()'>正在进行";
			...
			<div class="fl sub-cont">
				...
				<table class="table table-primary mt-30" border="1"  style="width:100%;min-width: 1000px;" >
					...
					<tr>
						...
						<span>备注栏：（若培养联系人姓名更改将会自动显示上一任培养联系人姓名）<textarea rows="5" cols="30" id="completionDescriptionStage55" style="float:none; min-height:auto;width:auto;"  ></textarea></span>
						</td>
						<td id="5"></td>
						<td><span><p>同上</p></span>
