        ...
        $.ajax({
            ...
            success : function (data) {
                if(data.success==true){
                    ...
                    setTimeout("window.location.href='sysUser/toUserOrganList.do'",3000);
                }else {
                    ...
                    <div class="user-form">
                        <form>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="input-text " name="orgCode" id="orgCode"  readonly onblur="validateMessage()" value="${sysOrganize.orgName}"> 
                            ...
                            <div class="form-group cl" >
                                ...
                                <div class="btn-wrap role-wrap" id="roles" > 
                                    <span class="btn btn-primary-outline "  data-value="CHECK_PERSONAL">个人</span>
