...
<script type="text/javascript">
    ...
    function getUserList(type) {
        ...
        var orgCode="${orgCode}";
        $.ajax({
            url : "sysUser/getUserOrganList.do",
            type : 'post',
            data :{ 
                    "operName" : operName,
                    "orgCode" : orgCode, 
            ...
            success :function (data) {
                ...
                for(var i in list){
                    ...
                    html += '<td>'+ 
                            ...
                            '<a class="btn btn-op ml-10" href="sysUser/toUserOrganAdd.do?operType=0&operId='+operId+'" title="修改"><i class="fa fa-edit"></i></a>'+
        ...
        <div class="panel-body">
            ...
            <div class="search-form">
                <form id="searchForm">
                    <div class="row cl"> 
                        <div class="col-sm-3">
                            <label class="form-label" for="">党员姓名：</label><div class="formControls "><input type="text" class="input-text " name="operName" id="operName" >
                        </div>
                        </div> 
                        <div class="col-sm-3 text-r">
                            <a  class="btn btn-primary" onclick="getUserList('1')">查询</a> 
							<a href="sysUser/toUserOrganAdd.do?operType=1" class="btn btn-secondary  ">新增</a> 
                        </div>
                    </div>
                </form>
            </div>
