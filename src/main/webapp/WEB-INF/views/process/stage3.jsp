            ...
            if(msg.flag){
                ...
                if(process.length>0){
                    ...
                    if(process[1].status==1){
                    	document.getElementById('72').innerHTML = "<input type='button' value='通过' onclick='updateRudangProcess72()'>正在进行";
                    ...
                    if(process[2].status==1){
                    	document.getElementById('73').innerHTML = "<input type='button' value='通过' onclick='updateRudangProcess73()'>正在进行";
                    ...
                    if(process[3].status==1){
                    	document.getElementById('74').innerHTML = "<input type='button' value='通过' onclick='updateRudangProcess74()'>正在进行";
                  ...
                  //Stage75完成情况
                    ...
                    if(process[4].status==1){
                    	document.getElementById('75').innerHTML = "<input type='button' value='通过' onclick='updateRudangProcess75()'>正在进行";
                  ...
                  //Stage81完成情况
                    ...
                    if(process[5].status==1){
                    	document.getElementById('81').innerHTML = "<input type='button' value='通过' onclick='updateRudangProcess81()'>正在进行";
                  ...
                  //Stage82完成情况
                    ...
                    if(process[6].status==1){
                    	document.getElementById('82').innerHTML = "<input type='button' value='通过' onclick='updateRudangProcess82()'>正在进行";
                  ...
                  //Stage9完成情况
                    ...
                    document.getElementById('9').innerHTML = "<input type='button' value='通过' onclick='updateRudangProcess9()'>";
                  ...
                  //Stage101完成情况
                    ...
                    if(process[8].status==1){
                    	document.getElementById('101').innerHTML = "<input type='button' value='通过' onclick='updateRudangProcess101()'>正在进行";
                    ...
                    if(process[9].status==1){
                    	document.getElementById('102').innerHTML = "<input type='button' value='通过' onclick='updateRudangProcess102()'>正在进行";
                    ...
                    if(process[10].status==1){
                    	document.getElementById('103').innerHTML = "<input type='button' value='通过' onclick='updateRudangProcess103()'>正在进行";
                  ...
                  //Stage11完成情况
                    ...
                    if(process[11].status==1){
                    	document.getElementById('11').innerHTML = "<input type='button' value='通过' onclick='updateRudangProcess11()'>正在进行";
				...
				<table class="table table-primary mt-30" border="1"  style="width:100%;min-width: 1000px;" >
					...
					<tr>
						...
						<td>
						    ...
						    <span>备注栏：（若入党介绍人姓名更改将会自动显示上一任入党介绍人姓名）<textarea rows="5" cols="30" id="completionDescriptionStage95" style="float:none; min-height:auto;width:auto;"  ></textarea></span>
						</td>
						<td id="9"></td>
						<td><span><p>同上</p></span>
