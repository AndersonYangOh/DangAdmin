               ...
               if(msg.flag){
                   ...
                   if(process.length>0){
                	...
                	$("#uncompletionDescriptionStage19").val(process[0].uncompletionDescription);
                       ...
                       if(process[0].status==1){
                       	document.getElementById('19').innerHTML = "正在进行";
                       ...
                       if(process[1].status==1){
                       	document.getElementById('20').innerHTML = "正在进行";
                       ...
                       */
                       ...
                       document.getElementById("completionDescriptionStage211").disabled=true;
                  	   document.getElementById("uncompletionDescriptionStage211").disabled=true;
                  
                       document.getElementById('211').innerHTML = "以“完成情况”为准";
                     ...
                     //Stage2121完成情况
                       ...
                       document.getElementById("completionDescriptionStage2121").disabled=true;
                  	   document.getElementById("uncompletionDescriptionStage2121").disabled=true;
                  
                       document.getElementById('2121').innerHTML = "以“完成情况”为准>";
                     ...
                     //Stage2122完成情况
                       ...
                       document.getElementById('2122').innerHTML = "以“完成情况”为准";
                       document.getElementById("completionDescriptionStage2122").disabled=true;
                  	   document.getElementById("uncompletionDescriptionStage2122").disabled=true;
                     ...
                     //Stage2123完成情况
                       ...
                       document.getElementById('2123').innerHTML = "以“完成情况”为准";
                       document.getElementById("completionDescriptionStage2123").disabled=true;
                  	   document.getElementById("uncompletionDescriptionStage2123").disabled=true;
                       ...
                       document.getElementById('2124').innerHTML = "以“完成情况”为准";
                       document.getElementById("completionDescriptionStage2124").disabled=true;
                  	   document.getElementById("uncompletionDescriptionStage2124").disabled=true;
                     ...
                     //Stage213完成情况
                       ...
                       if(process[7].status==1){
                       	document.getElementById('213').innerHTML = "正在进行";
                     ...
                     //Stage221完成情况
                       ...
                       if(process[8].status==1){
                       	document.getElementById('221').innerHTML = "正在进行";
                     ...
                     //Stage222完成情况
                       ...
                       if(process[9].status==1){
                       	document.getElementById('222').innerHTML = "正在进行";
                     ...
                     //Stage223完成情况
                       ...
                       if(process[10].status==1){
                       	document.getElementById('223').innerHTML = "正在进行";
                       ...
                       if(process[11].status==1){
                       	document.getElementById('231').innerHTML = "正在进行";
                       ...
                       if(process[12].status==1){
                        document.getElementById('232').innerHTML = "正在进行";
                        ...
                        //Stage233完成情况
                          ...
                          if(process[13].status==1){
                          	document.getElementById('233').innerHTML = "正在进行";
                       ...
                       if(process[14].status==1){
                         	document.getElementById('234').innerHTML = "正在进行";
                       ...
                       if(process[15].status==1){
                         	document.getElementById('235').innerHTML = "正在进行";
                  ...
                  //   $("#completionDescriptionStage241").val(process[13].completionDescription);
                       ...
                       if(process[16].status==1){
                       	document.getElementById('241').innerHTML = "正在进行";
                     ...
                     //Stage242完成情况
                       ...
                       if(process[17].status==1){
                       	document.getElementById('242').innerHTML = "正在进行";
                     ...
                     //Stage243完成情况
                       ...
                       if(process[18].status==1){
                       	document.getElementById('243').innerHTML = "正在进行";
                     ...
                     //Stage25完成情况
                       ...
                       if(process[19].status==1){
                       	document.getElementById('25').innerHTML = "正在进行";
