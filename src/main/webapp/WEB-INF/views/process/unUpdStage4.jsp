...
function right(){
	var loca = "Process/toRudangProcess.do?geren=geren&materialId=5&operId="+operId;
            ...
            if(msg.flag){
                ...
                if(process.length>0){
                    ...
                    if(process[0].status==1){
                    	document.getElementById('121').innerHTML = "正在进行";
                    ...
                    if(process[1].status==1){
                    	document.getElementById('122').innerHTML = "正在进行";
                    ...
                    if(process[2].status==1){
                    	document.getElementById('131').innerHTML = "正在进行";
                    ...
                    if(process[3].status==1){
                    	document.getElementById('132').innerHTML = "正在进行";
                  ...
                  //Stage141完成情况
                    ...
                    if(process[4].status==1){
                    	document.getElementById('141').innerHTML = "正在进行";
                  ...
                  //Stage142完成情况
                    ...
                    if(process[5].status==1){
                    	document.getElementById('142').innerHTML = "正在进行";
                  ...
                  //Stage1511完成情况
                    ...
                    if(process[6].status==1){
                    	document.getElementById('1511').innerHTML = "正在进行";
                  ...
                  //Stage152完成情况
                    ...
                    if(process[13].status==1){
                    	document.getElementById('152').innerHTML = "正在进行";
                  ...
                  //Stage153完成情况
                    ...
                    if(process[14].status==1){
                    	document.getElementById('153').innerHTML = "正在进行";
                    ...
                    if(process[15].status==1){
                    	document.getElementById('154').innerHTML = "正在进行";
                  ...
                  //Stage155完成情况
                    ...
                    if(process[16].status==1){
                    	document.getElementById('155').innerHTML = "正在进行";
                  ...
                  //Stage156完成情况
                    ...
                    if(process[17].status==1){
                    	document.getElementById('156').innerHTML = "正在进行";
                  ...
                  //Stage16完成情况
                    ...
                    if(process[18].status==1){
                    	document.getElementById('16').innerHTML = "正在进行";
                  ...
                  //Stage17完成情况
                    ...
                    if(process[19].status==1){
                    	document.getElementById('17').innerHTML = "正在进行";
                  ...
                  //Stage18完成情况
                    ...
                    if(process[20].status==1){
                    	document.getElementById('18').innerHTML = "正在进行";
