...
public class PathFormat {
	...
	public static String parse ( String input,Date postTime) throws Exception{
		
		Pattern pattern = Pattern.compile( "\\{([^\\}]+)\\}", Pattern.CASE_INSENSITIVE  );
		Matcher matcher = pattern.matcher(input);
		//将发布日期转化为时间格式
		PathFormat.currentDate = postTime;
	...
	public static String parse ( String input, Date postTime,String filename ) throws Exception{
